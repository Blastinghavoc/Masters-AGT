...

{
	...
	m_heightmap = engine::heightmap::create("assets/textures/heightmap.bmp", "assets/textures/terrain.bmp", 100.f, 100.f, glm::vec3(0.f, 0.f, 0.f), 10.f);
	engine::game_object_properties terrain_props;
	terrain_props.meshes = { m_heightmap->mesh() };
	terrain_props.textures = { m_heightmap->texture() };
	terrain_props.is_static = true;
	terrain_props.type = 0;
	terrain_props.bounding_shape = glm::vec3(m_heightmap->terrain_size().x, m_physical_terrain_height, m_heightmap->terrain_size().z);
	...
	cow_props.position = { -3.f,0.5f, -5.f };
...
void example_layer::on_render() 
{
	...
	m_ball->transform(ball_transform);
	ball_transform = glm::translate(ball_transform, glm::vec3(0.f, m_heightmap->ground_height(m_ball->position()) - m_physical_terrain_height, 0.f));
	engine::renderer::submit(material_shader, ball_transform, m_ball);
