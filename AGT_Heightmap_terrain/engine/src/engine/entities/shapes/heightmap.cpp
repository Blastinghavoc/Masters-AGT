...
engine::heightmap::heightmap(std::string sTerrainFilename, std::string sTextureFilename, float terrainSizeX, float terrainSizeZ, glm::vec3 origin, float terrainHeightScale)
{
	...
	if (image_bytes(sTerrainFilename, &bDataPointer) == true)
	{
		...
		m_height_scale = terrainHeightScale;
...
engine::ref<engine::heightmap> engine::heightmap::create(std::string sTerrainFilename, std::string sTextureFilename, float terrainSizeX, float terrainSizeZ, glm::vec3 origin, float terrainHeightScale)
{
