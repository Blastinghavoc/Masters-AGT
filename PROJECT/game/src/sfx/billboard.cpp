...
engine::ref<billboard> billboard::create(std::string sprite_filename, uint32_t frames_x, uint32_t frames_y, uint32_t num_frames)
{
	return std::make_shared<billboard>(sprite_filename, frames_x, frames_y, num_frames);
}
